...
Image {
	property string buttonText: modelSet["char"][rowNumber][index];
	property variant buttonCode: modelSet["code"][rowNumber][index];
	property string sourceString: "";
	property string sourceStringHighlight: "";
	property string sourceStringPressed: "";
	property bool isHighlighted: (keyboardListView.currentIndex === index && activeFocus) ? true : false;
	property string testIndex: index;
	property string fontSetting: "";
	property bool mousePressed: false;
	property variant target: keyboardTextBox;
